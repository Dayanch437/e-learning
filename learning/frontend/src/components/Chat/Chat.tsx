...
import { Card, Input, Button, List, Avatar, Spin, Select, Tabs, Tooltip, message, Divider } from 'antd';
import { SendOutlined, RobotOutlined, UserOutlined, PlusOutlined, DeleteOutlined, EditOutlined } from '@ant-design/icons';
...
const Chat: React.FC = () => {
  ...
  const createNewSession = async () => {
    try {
      ...
      setSessions(Array.isArray(sessions) ? [...sessions, response.data] : [response.data]);
  ...
  return (
    <div className="chat-container">
      <div className="chat-sidebar" style={{ display: isMobile ? 'none' : 'flex' }}>
                  ...
                  renderItem={message => (
                    <List.Item className={`message ${message.role}`}>
                      <List.Item.Meta
                        ...
                        title={message.role === 'assistant' ? 'Teacher Emma' : user?.username || 'You'}
                        description={
